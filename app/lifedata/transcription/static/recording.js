  ...
  let onSuccess = function (stream) {
    ...
    const blob = new Blob(chunks, { type: "audio/wav" });
      ...
      saveButton.onclick = function (e) {
        ...
        // var formData = new FormData(document.getElementsByClassName('sound-clips'));
...
function visualize(stream) {
  ...
  function draw() {
    // console.log(mainSection.offsetWidth, canvas.width, canvas.height)
    const WIDTH = canvas.width;
    // const WIDTH = mainSection.offsetWidth;
