...
def delete_one_data(projects_collection,
    ...
    try:
        ...
        logger.debug('DELETED crawled_data_doc_id: %s, %s', crawled_data_doc_id, type(crawled_data_doc_id))
...
def revoke_deleted_data(projects_collection,
    ...
    try:
        ...
        crawled_data_doc_id = data_collection.find_one_and_update({
            ...
            projection={'_id': True},
            return_document=ReturnDocument.AFTER)['_id']
        logger.debug('REVOKED crawled_data_doc_id: %s, %s', crawled_data_doc_id, type(crawled_data_doc_id))
