...
#######################################################
    ...
    if request.method =='POST':
        ...
        if accesscode == '':
            ...
            previous_name = previous_speakerdetails["current"]["speakerMetadata"]["name"]
            previous_agegroup = previous_speakerdetails["current"]["speakerMetadata"]["agegroup"]
            previous_gender = previous_speakerdetails["current"]["speakerMetadata"]["gender"]
            previous_educationlevel = previous_speakerdetails["current"]["speakerMetadata"]["educationlevel"]
            previous_educationmediumupto12 = previous_speakerdetails["current"]["speakerMetadata"]["educationmediumupto12"]
            previous_educationmediumafter12 = previous_speakerdetails["current]speakerMetadata.educationmediumafter12"]
            previous_speakerspeaklanguage = previous_speakerdetails["current"]["speakerMetadata"]["speakerspeaklanguage"]
            previous_recordingplace = previous_speakerdetails["current"]["speakerMetadata"]["recordingplace"]


            previous_update_data = {"previous.speakerMetadata.name": previous_name, 
                                        "previous.speakerMetadata.agegroup": previous_agegroup, 
                                        "previous.speakerMetadata.gender": previous_gender,
                                        "previous.speakerMetadata.educationlevel": previous_educationlevel,
                                        "previous.speakerMetadata.educationmediumupto12": previous_educationmediumupto12,
                                        "previous.speakerMetadata.educationmediumafter12": previous_educationmediumafter12,
                                        "previous.speakerMetadata.speakerspeaklanguage": previous_speakerspeaklanguage,
                                        "previous.speakerMetadata.recordingplace": previous_speakerdetails,
                                        "isActive": 1}
                       
            mongodb_info.update_one({"lifespeakerid": accesscode}, {"$set": previous_update_data, "currentdate" : current_date})
            mongodb_info.update_one({"lifespeakerid": accesscode}, {"$set": update_data})
