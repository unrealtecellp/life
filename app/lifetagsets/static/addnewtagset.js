...
function tagsetDetailForm(cur_id) {
    console.log('Current ID', cur_id)
    ...
    let sourceinpt = ''
    let subsourceinpt = ''
    sourceinpt += '<form action="/addnewtagset" method="POST" enctype="multipart/form-data">';
