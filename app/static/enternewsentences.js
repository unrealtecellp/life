...
'id="sentenceMorphemicBreak' + sentenceField +'" required>'+
'<div class="input-group-btn">'+
...
morphemeinput += '<div class="input-group">'+
    '<input type="text" class="form-control" name="morphemeField' +sid+ (i+1) +'"'+'placeholder="'+morphemicSplitSentence[i]+'" value="'+morphemicSplitSentence[i]+'" id="morphemeField' +sid+ (i+1) +'" required/>'+
    '<span class="input-group-btn" style="width:50px;"></span>'+
    '<select class="morphemicgloss' +sid+ (i+1) +'" name="morphemicgloss' +sid+ (i+1) +'" multiple="multiple" style="width: 210px" required></select>'+
    '<span class="input-group-btn" style="width:50px;"></span>'+
    '<select class="lextype' +sid+ (i+1) +'" name="lextype' +sid+ (i+1) +'" style="width: 210px" required>'+
...
morphemeinput += '<div class="input-group">'+
  '<input type="text" class="form-control" name="morphemeField' +sid+ (i+1) +'"'+'placeholder="'+morphemicSplitSentence[i]+'" value="'+morphemicSplitSentence[i]+'" id="morphemeField' +sid+ (i+1) +'" required/>'+
  '<span class="input-group-btn" style="width:50px;"></span>'+
  '<input type="text" class="form-control" name="morphemicgloss' +sid+ (i+1) +'"'+' id="morphemicgloss' +sid+ (i+1) +'" required/>'+
  '<span class="input-group-btn" style="width:50px;"></span>'+
  '<select class="lextype' +sid+ (i+1) +'" name="lextype' +sid+ (i+1) +'" style="width: 210px"></select>'+
  '<span class="input-group-btn" style="width:50px;"></span>'+
  '<select class="pos' +sid+ (i+1) +'" name="pos' +sid+ (i+1) +'" style="width: 210px" required>'+
...
var sentenceTraslationField = '<p><strong>Translation of the Sentence</strong></p><div class="col-md-12">'+
            ...
            'id="sentenceTranslation' + sid +'" required>'+
            '</div>';
